...
export const metadata: Metadata = {
    ...
    description: 'Subnautica is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Subnautica accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Subnautica accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Subnautica is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Subnautica presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Subnautica. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@subnautica.online</strong></li>
                </ul>
                <p>
