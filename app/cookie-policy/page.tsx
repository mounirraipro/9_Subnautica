...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Subnautica uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Subnautica cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Subnautica uses them, and how you can
                ...
                <p>Subnautica uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Subnautica.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@subnautica.online</strong>.
                </p>
            </div>
        </>
    );
